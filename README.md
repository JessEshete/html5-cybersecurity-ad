...
Each format uses a layout designed specifically for its dimensions rather than simply scaling the original design.
...
Campaign elements enter sequentially:

1. Security Awareness label
2. Warning icon
3. Main headline
